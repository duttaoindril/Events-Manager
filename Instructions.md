# What to do
- Install Virtualbox and Vagrant. It is best to install these from the respective websites.
- `vagrant up`
- `vagrant ssh`
...
* How to test it (i.e. what hostname do we visit)

Remember, we may test this with a much larger dataset than what we provided here.
